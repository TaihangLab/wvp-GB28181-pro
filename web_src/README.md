...
## 项目简介
这是一个基于Vue.js的智能视觉AI预警管理系统，提供实时监控、预警管理、技能管理等功能。

## 主要功能

### 预警管理 (warningManagement.vue)
- **实时预警监控**：显示各类安全预警信息
- **多条件筛选**：支持按时间、等级、类型、位置等筛选
- **批量操作**：支持批量处理、删除等操作
- **预警处理**：提供上报、归档、误报标记等处理方式
- **智能复判**：集成AI复判功能，提高预警准确性

### 最新UI改进 (2024-12-18)
预警管理页面已升级为科技感蓝色UI设计：

#### 视觉特效
- **科技感渐变背景**：采用蓝色系渐变，营造现代科技氛围
- **卡片悬浮效果**：鼠标悬停时卡片会上浮，增强交互体验
- **动态光效**：卡片背景添加微妙的蓝色渐变光效
- **现代化圆角设计**：所有元素使用统一的圆角设计语言

#### 交互优化
- **按钮渐变效果**：所有操作按钮使用渐变色设计，提升视觉层次
- **悬停动画**：按钮悬停时有上浮和阴影变化效果
- **输入框焦点效果**：输入框获得焦点时有蓝色边框高亮
- **对话框美化**：所有弹窗对话框采用统一的科技感设计

#### 色彩方案
- **主色调**：科技蓝 (#3b82f6, #1e40af)
- **辅助色**：天蓝 (#06b6d4)
- **背景色**：浅灰渐变 (#fafafa -> #f5f5f5)
- **卡片色**：白色带蓝色光晕
